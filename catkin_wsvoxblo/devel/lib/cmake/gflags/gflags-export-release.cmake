...
set_target_properties(gflags-shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgflags.so.2.1.2"
  IMPORTED_SONAME_RELEASE "libgflags.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS gflags-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gflags-shared "${_IMPORT_PREFIX}/lib/libgflags.so.2.1.2" )
...
set_target_properties(gflags_nothreads-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgflags_nothreads.so.2.1.2"
  IMPORTED_SONAME_RELEASE "libgflags_nothreads.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS gflags_nothreads-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gflags_nothreads-shared "${_IMPORT_PREFIX}/lib/libgflags_nothreads.so.2.1.2" )
