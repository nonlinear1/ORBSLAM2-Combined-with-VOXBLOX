...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/best_jill_forever/catkin_ws/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/best_jill_forever/catkin_ws/devel)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/best_jill_forever/catkin_ws/install)
...
if(NOT "/home/best_jill_forever/catkin_ws/src/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/best_jill_forever/catkin_ws/src/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/best_jill_forever/catkin_ws/src/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
